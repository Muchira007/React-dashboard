    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          ...
          <span className='text-muted mt-1 fw-semibold fs-7'>More than 40 new products</span>
        </h3>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <span className='text-muted fw-semibold d-block'>Fertilizers</span>
                    </td>
                  ...
                  <tr>
                    ...
                    {/* <td className='text-end text-muted fw-semibold'>Approved</td> */}
                    <td className='text-end text-muted fw-semibold'></td>
                    <td className='text-end'>
                      {/* <span className='badge badge-light-warning'>Approved</span> */}
                      <span className='badge badge-light-success'>Approved</span>
                    </td>
                    <td className='text-end'>
                      <a
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span className='text-muted fw-semibold d-block'> Users</span>
                    </td>
                  ...
                  {/* <tr>
                    ...
                    <td>
                      ...
                      <span className='text-muted fw-semibold d-block'>Farmers, Cattle rearer's</span>
                    </td>
                    <td className='text-end text-muted fw-semibold'></td>
                    <td className='text-end'>
                      <span className='badge badge-light-danger'>Approved</span>
                      <span className='badge badge-light-success'>Approved</span>
                    </td>
                    <td className='text-end'>
                      <a
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span className='text-muted fw-semibold d-block'>Maize and beans seedlings</span>
                    </td>
                    <td className='text-end text-muted fw-semibold'></td>
                    <td className='text-end'>
            ...
            <div className='table-responsive'>
              ...
              <table className='table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4'>
                ...
                <tr>
                    ...
                    {/* <td className='text-end text-muted fw-semibold'>Fertilizers</td> */}
                    <td className='text-end'>
                      <span className='badge badge-light-success'>Approved</span>
                    </td>
                    <td className='text-end'>
