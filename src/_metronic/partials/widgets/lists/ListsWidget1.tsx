      ...
      <div className='card-body pt-5'>
        ...
        <div className='d-flex align-items-center mb-7'>
          ...
          <div className='d-flex flex-column'>
            ...
            <span className='text-muted fw-semibold'>Finance</span>
          </div>
          {/* end::Text */}
        </div>
        {/* end::Item */}
        ...
        <div className='d-flex align-items-center mb-7'>
          ...
          <div className='d-flex flex-column'>
            ...
            <span className='text-muted fw-semibold'>Technical Support</span>
          </div>
          {/* end::Text */}
        </div>
        {/* end::Item */}
        ...
        <div className='d-flex align-items-center mb-7'>
          ...
          <div className='d-flex flex-column'>
            ...
            <span className='text-muted fw-semibold'>Accounts</span>
          </div>
          {/* end::Text */}
        </div>
        {/* end::Item */}
