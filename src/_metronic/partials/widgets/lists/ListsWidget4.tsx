    ...
    <div className='card card-xl-stretch mb-xl-8'>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          ...
          <span className='text-muted mt-1 fw-semibold fs-7'>Latest trends</span>
        </h3>
      ...
      <div className='card-body pt-5'>
        ...
        <div className='d-flex align-items-sm-center mb-7'>
          ...
          <div className='d-flex align-items-center flex-row-fluid flex-wrap'>
            ...
            <span className='badge badge-light fw-bold my-2'>+8200 KES</span>
          </div>
          {/* end::Section */}
        </div>
        {/* end::Item */}
        ...
        <div className='d-flex align-items-sm-center mb-7'>
          ...
          <div className='d-flex align-items-center flex-row-fluid flex-wrap'>
            <div className='flex-grow-1 me-2'>
              ...
              <span className='text-muted fw-semibold d-block fs-7'>Joshua, Steve, Mike</span>
            </div>
            <span className='badge badge-light fw-bold my-2'>+2800 KES</span>
          </div>
          {/* end::Section */}
        </div>
        {/* end::Item */}
        ...
        <div className='d-flex align-items-sm-center mb-7'>
          ...
          <div className='d-flex align-items-center flex-row-fluid flex-wrap'>
            ...
            <span className='badge badge-light fw-bold my-2'>+45000 KES</span>
          </div>
          {/* end::Section */}
        </div>
        {/* end::Item */}
        ...
        <div className='d-flex align-items-sm-center mb-7'>
          ...
          <div className='d-flex align-items-center flex-row-fluid flex-wrap'>
            ...
            <span className='badge badge-light fw-bold my-2'>+4500 KES</span>
          </div>
          {/* end::Section */}
        </div>
        {/* end::Item */}
